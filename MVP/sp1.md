...
- Relacionar códigos econômicos às suas descrições;
- Preparar os dados para criação de gráficos;
- Desenvolver análises sobre os principais setores econômicos;
- Iniciar a construção das visualizações;
- Preparar os dados geográficos para utilização em mapas.
